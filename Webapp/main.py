...
UPLOAD_FOLDER = '/home/trying_shant/IIT/ITSP/webapp/downloads'
app = Flask(__name__)
...
def load_glove_embeddings(dim):
  ...
  input_path = '/home/trying_shant/IIT/ITSP/webapp/'
...
text_data_path = "/home/trying_shant/IIT/ITSP/webapp/"
...
MFCC_F = keras.models.load_model('/home/trying_shant/IIT/ITSP/webapp/MFCC_Based_Detector_F.h5')
MFCC_M = keras.models.load_model('/home/trying_shant/IIT/ITSP/webapp/MFCC_Based_Detector_M.h5')
Mel_F = keras.models.load_model('/home/trying_shant/IIT/ITSP/webapp/Mel_Based_Detector_F.h5')
Mel_M = keras.models.load_model('/home/trying_shant/IIT/ITSP/webapp/Mel_Based_Detector_M.h5')
Words = keras.models.load_model('/home/trying_shant/IIT/ITSP/webapp/Words_Based_Detector.h5')
...
def upload():
    ...
    if request.method == "POST":
        ...
        file_path = '/home/trying_shant/IIT/ITSP/webapp/downloads/' + 'temp.wav' 
        ...
        print(Words.predict(x_train))
      
        mel_M_out,mel_F_out,mfcc_M_out,mfcc_F_out = frequency(file_path)
        print("mel,mfcc- " + str(mel_M_out) + str(mel_F_out) + str(mfcc_M_out) + str(mfcc_F_out))
