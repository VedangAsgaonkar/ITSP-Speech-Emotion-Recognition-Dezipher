...
This repository store the speech emotion recognition web-app made as ITSP. This project was done by Team Technologic: [Vedang Asgaonkar](@VedangAsgaonkar), [Prathamesh Pilkhane](@Prathamesh2708), [Parshant Arora](@Parshant-Arora) and [Pulkit Agarwal](@PulkitAgr113).
